...
<h3>Shopping Portal</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Dhanshree Engineering is one of the leading mechanical product supplier from Maharashtra, India.</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">info@dhanshree.com</a></span>
                </div>
            </li>
